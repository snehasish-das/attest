...
$history_url = $_SESSION['site-url'] . '/api/history/'.$id;
$history = json_decode($cta->httpGetWithAuth($history_url,$_SESSION['auth-phrase']), true);
                                                            ...
                                                            <div class="col-lg-12">
                                                                <div class="searchable-container">
                                                                    <div class="searchable-items">
                                                                        ...
                                                                        <div class="items">
                                                                            <div class="user-name">
                                                                                <p class=""><?php echo $item['execution_date'] ?></p>
                                                                            </div>
                                                                            <div class="user-name">
                                                                                <p class=""><?php echo $item['parent_node'] ?></p>
                                                                            </div>
                                                                            <div class="user-email">
                                                                                <p><?php echo $item['test_run_link'] ?></p>
                                                                            </div>
                                                                            <div class="user-status">
                                                                                <span
                                                                                    class="badge badge-<?php if($item['test_status'] == 'Passed'){echo 'success';} else if($item['test_status'] == 'Not Started'){echo 'warning';} else{echo 'danger';} ?>"><?php echo $item['test_status']; ?></span>
                                                                            </div>
                                                                            <div class="user-status">
                                                                                <p><?php echo $item['bug_no'] ?></p>
                                                                            </div>
                                                                        </div>
                                                                        <?php } ?>
                                                                    </div>
